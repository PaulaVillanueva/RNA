...
\lstinputlisting[language=Python]{../ej2_data_loader.py}
...
\lstinputlisting[language=Python]{../layer.py}
...
\lstinputlisting[language=Python]{../predict1.py}

\lstinputlisting[language=Python]{../trainnet1.py}

Ejercicio 2:

\lstinputlisting[language=Python]{../test3.py}
